...
# إضافة الهيدر مع استبدال LOGO_HTML بشكل صحيح
st.markdown(
    f"""
<style>
    #custom-header-root {{
...
<div id="custom-header-root">
    <div class="custom-top-header">
        <div class="custom-header-container">
            ...
            <label for="custom-menu-toggle" class="custom-menu-open-btn">☰ القائمة</label>
        </div>
    </div>
    ...
    <nav class="custom-side-navigation" id="sideMenu" aria-label="القائمة الرئيسية">
        <div class="custom-side-navigation-header">
            ...
            <label for="custom-menu-toggle" class="custom-close-btn" aria-label="إغلاق القائمة">×</label>
        </div>

        <a href="?page=home" target="_top" class="nav-link">🏠 الرئيسية</a>
        <a href="?page=about" target="_top" class="nav-link">ℹ️ من نحن</a>
        <a href="?page=programs" target="_top" class="nav-link">⚽ البرامج التدريبية</a>
        <a href="?page=captains" target="_top" class="nav-link">👨‍🏫 صفحة الكباتن</a>
        <a href="?page=registration" target="_top" class="nav-link">📝 سجل لاعب جديد</a>
        <a href="?page=faq" target="_top" class="nav-link">❓ الأسئلة الشائعة</a>
        <a href="?page=contact" target="_top" class="nav-link">📞 اتصل بنا</a>
        <a href="?page=news" target="_top" class="nav-link">📰 الأخبار</a>
    </nav>
...
if page == 'home':
    ...
    with col2:
        st.markdown("""
        <div class="custom-primary-links" style="margin-bottom: 55px;">
            <a class="custom-register-btn" href="?page=registration" target="_top">📝 سجل الآن</a>
            <a class="custom-register-btn" href="?page=contact" target="_top" style="background: linear-gradient(135deg, #0f172a, #334155, #0f172a); animation: none;">📞 اتصل بنا</a>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="custom-features-grid">
        <div class="custom-feature-card"><div class="custom-feature-icon">🧠</div><h3>منهجية التدريب الذهني</h3><p>نركز على تطوير الذكاء الكروي والقدرات العقلية للاعبين</p></div>
        <div class="custom-feature-card"><div class="custom-feature-icon">🛡️</div><h3>بيئة آمنة محفزة</h3><p>نوفر بيئة تدريب آمنة تحترم الفروق الفردية بين اللاعبين</p></div>
        <div class="custom-feature-card"><div class="custom-feature-icon">🤝</div><h3>شراكات مع الأندية</h3><p>لدينا شراكات مع أندية محلية ودولية لاحتراف اللاعبين</p></div>
    </div>
    """, unsafe_allow_html=True)
    ...
    for i, news in enumerate(news_preview):
        with cols[i]:
            ...
            <div style="background: white; border-radius: 20px; padding: 20px; text-align: center; border-right: 3px solid #f59e0b;">
                ...
                <a href="?page=news" target="_top" style="color: #3b82f6; text-decoration: none; font-weight: 700;">اقرأ المزيد →</a>
            </div>
            """, unsafe_allow_html=True)
...
# ====================================================================================================
    ...
    <div class="custom-mission-vision-grid">
        <div class="custom-mission-card">
            ...
            <p style="color: #334155; line-height: 1.7;">تطوير جيل جديد من اللاعبين المبدعين القادرين على التألق محليًا ودوليًا</p>
        ...
        <div class="custom-vision-card">
            ...
            <p style="color: #334155; line-height: 1.7;">أن نكون الوجهة الأولى لأي موهبة كروية في مصر والوطن العربي</p>
            <ul style="margin-right: 20px; margin-top: 20px; color: #334155;">
        ...
        <div class="custom-program-body">
            ...
            <div class="custom-schedule-box">
                ...
                <ul style="margin-right: 20px;">
                    ...
                    <li>فيديوهات تحليل أداء للاعبين المتم��زين</li>
...
# ====================================================================================================
    ...
    st.markdown("""
    <div class="custom-coach-card" style="margin-bottom: 30px;">
        <div class="custom-coach-avatar">👨‍🏫</div>
        <div class="custom-coach-info">
            <h3>كابتن/ميخائيل كميل رؤف</h3>
            <div class="custom-coach-title">المدير الفني - مؤسس الأكاديمية</div>
            <div class="custom-coach-desc">
                🎓 بكالريوس تربية رياضية<br>
                📜 رخصة تدريب CAF لمراحل البراعم<br>
                📜 دبلومة الإعداد البدني المتقدم<br>
                📜 دبلومة إصابات الملاعب والعلاج الطبيعي<br>
                🏫 مدرس تربية رياضية بمدارس السلام الخاصة
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
        ...
        <div class="custom-coach-card">
            ...
            <div class="custom-coach-info">
                ...
                <div class="custom-coach-desc">
                    ...
                    📜 حاصل على دورات متقدمة في تدريب الناشئين
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="margin-top: 30px; background: linear-gradient(135deg, #1e3a8a, #3b82f6); border-radius: 28px; padding: 36px; text-align: center; color: white;">
    ...
    faqs = [
        ("ما الذي يميز الكوتش أكاديمي عن غيرها من الأكاديميات؟", 
         "الكوتش أكاديمي تتبنى منهجية تدريب متكاملة وشاملة تركز على عدة محاور: (1) التدريب الذهني وتطوير الذكاء الكروي (2) تطوير المهارات الفنية المتقدمة (3) إعداد بدني متخصص (4) الدعم النفسي والقيمي"),
        
        ("ما هي مدة التدريب وأوقاته؟", 
         "الموسم التدريبي يمتد لمدة 10 أشهر، من بداية سبتمبر إلى نهاية يونيو. التدريبات تقام في الفترة المسائية يومي السبت والخميس"),
        
        ("ما هي تكلفة الاشتراك وآلية الدفع؟", 
         "تختلف التكلفة حسب الفئة العمرية. نقدم عدة مزايا: خصومات خاصة للأشقاء، نظام دفع مرن"),
        
        ("ما هي متطلبات الانضمام للأكاديمية؟", 
         "للانضمام للأكاديمية نحتاج إلى: (1) إكمال نموذج التسجيل (2) أن يكون اللاعب في الفئة العمرية المناسبة (3) الرغبة الحقيقية في التعلم والتطور"),
        
        ("هل هناك تدريبات خاصة للمبتدئين؟", 
         "نعم، لدينا برامج خاصة للمبتدئين تركز على تعلم أساسيات كرة القدم من الصفر"),
        
        ("كيف يمكن متابعة تطور اللاعب داخل الأكاديمية؟", 
         "نوفر نظام متابعة شامل يشمل: تقييم فني دوري وتقارير تطور الأداء"),
        
        ("ماذا عن السلامة والإصابات خلال التدريب؟", 
         "السلامة هي أولوية قصوى لدينا، ونوفر: (1) إشراف مستمر من مدربين مؤهلين (2) بيئة تدريب آمنة (3) تأمين صحي للاعبين"),
        
        ("هل يمكن للاعب الانتقال بين الفئا�� العمرية؟", 
         "نعم، يمكن للاعب الانتقال بناءً على معايير محددة مثل تطور مهاراته"),
        
        ("ما هي اللغات المستخدمة في التدريب؟", 
         "التدريب يتم باللغة العربية الفصحى والعامية مع استخدام المصطلحات الإنجليزية"),
        
        ("هل يوجد تدريبات مخصصة للبنات؟", 
         "نعم، لدينا برامج تدريبية مخصصة للبنات مع مدربات متخصصات"),
        
        ("كم عدد اللاعبين في المجموعة التدريبية الواحدة؟", 
         "نحرص على أن يكون عدد اللاعبين مناسبًا لضمان الجودة"),
        
        ("هل توجد مسابقات دورية داخل الأكاديمية؟", 
         "نعم، نقوم بتنظيم مسابقات دورية داخلية وخارجية"),
        
        ("كيف يمكنني التواصل مع إدارة الأكاديمية؟", 
         "يمكنك التواصل عبر: الهاتف 01069238878، الواتساب 01285197778، أو البريد info@elcoach-academy.com"),
        
        ("هل توجد وسائل نقل للاعبين؟", 
         "حالياً، لا نوفر خدمات نقل لكننا نعمل على توفيرها في المستقبل"),
        
        ("ما هي شروط الانسحاب واسترداد الرسوم؟", 
         "يتم استرداد الرسوم وفقًا لسياسة محددة: استرداد كامل خلال أول أسبوعين، استرداد 50% بعد ذلك"),
        
        ("هل يوجد عروض خاصة للأشقاء؟", 
         "نعم، نقدم خصم 15% للشقيق الثاني، وخصم 25% للشقيق الثالث"),
    ]
...
# ====================================================================================================
    ...
    with col1:
        ...
        <div class="custom-contact-card">
            ...
            <div class="custom-contact-item">
                ...
                <div>
                    ...
                    السبت والخميس: 4:00 مساءً - 9:00 مساءً
                </div>
            </div>
            <div class="custom-contact-item">
                <div style="font-size: 1.6rem;">📧</div>
        ...
        <div class="custom-map-container">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113686.258448786!2d31.156289!3d27.186696!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1438a5f5c5b5b5b5%3A0x50b5b5b5b5b5b5b5!2s%D8%A3%D8%B3%D9%8A%D9%88%D8%B7!5e0!3m2!1sar!2seg!4v1234567890"
    ...
    with col2:
        ...
        with st.form("contact_form"):
            ...
            c_msg = st.text_area("الرسال�� *", height=130, placeholder="اكتب رسالتك هنا بتفصيل...")
...
# ====================================================================================================
    ...
    news_items = [
        {"title": "بدء التسجيل للموسم الجديد 2025", "date": "2025-01-15", "author": "الإدارة", "content": "يعلن الكوتش أكاديمي عن بدء التسجيل للموسم الجديد 2025 مع عروض خاصة للمبكرين"},
        {"title": "فوز فريق الأكاديمية ببطولة أسيوط", "date": "2025-01-10", "author": "الفريق الإخباري", "content": "حقق فريق تحت 12 سنة فوزًا مستحقًا في بطولة أسيوط المحلية"},
        {"title": "محاضرة تدريبية للمدربين", "date": "2025-01-05", "author": "الفريق الإخباري", "content": "أقيمت محاضرة تدريبية للمدربين حول أحدث أساليب التدريب العالمية"},
        {"title": "افتتاح فرع جديد للأكاديمية", "date": "2024-12-20", "author": "الإدارة", "content": "يعلن الكوتش أكاديمي عن افتتاح فرع جديد في مدينة نجع حمادي"},
        {"title": "تخريج دفعة جديدة من اللاعبين", "date": "2024-12-15", "author": "الفريق الإخباري", "content": "احتفلت الأكاديمية بتخريج دفعة جديدة من اللاعبين المحترفين"},
        {"title": "مشاركة مميزة في بطولة الجمهورية", "date": "2024-12-10", "author": "الفريق الإخباري", "content": "شارك فريق الأكاديمية في بطولة الجمهورية للناشئين بمستوى ممتاز"},
        {"title": "دورة تدريبية لحراس المرمى", "date": "2024-12-05", "author": "قسم حراس المرمى", "content": "انطلقت دورة تدريبية متخص��ة لحراس المرمى تحت إشراف مدربين معتمدين"},
        {"title": "اتفاقية تعاون مع نادي الزمالك", "date": "2024-11-28", "author": "الإدارة", "content": "وقع الكوتش أكاديمي اتفاقية تعاون مع نادي الزمالك لاحتراف المواهب"},
    ]
...
<div class="custom-main-footer">
    <div class="custom-footer-grid">
        <div>
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                <div style="width: 55px; height: 55px; background: linear-gradient(135deg, #3b82f6, #1e3a8a); border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 2rem; color: white;">⚽</div>
                <h3 style="color: white; margin: 0; font-size: 1.5rem;">الكوتش أكاديمي</h3>
            </div>
            <p style="color: #cbd5e1; font-size: 0.9rem; line-height: 1.8;">
                تأسست عام 2020 على ملاعب مدرسة السلام المتطورة.
                أول أكاديمية متخصصة في مصر تركز على بناء اللاعب الشامل من الناحية الفنية والبدنية والنفسية،
                تحت إشراف مدربين معتمدين دوليًا من الاتحاد الأفريقي CAF.
            </p>
    ...
    <div style="text-align: center; padding-top: 30px; border-top: 1px solid rgba(255, 255, 255, 0.1); margin-top: 20px;">
