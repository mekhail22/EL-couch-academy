...
# ====================================================================================================
# REGISTRATION PAGE - مع إضافة المجموعات الجديدة للصف الثالث/الرابع والخامس/السادس
# ====================================================================================================
    ...
    if current_count >= MAX_PLAYERS:
        ...
        with st.form("registration_form"):
            ...
            with col1:
                ...
                age_group = st.selectbox(
                    ...
                    [
                        ...
                        "KG1 (بنين)",
                        "KG2 (بنين)",
                        "الصف الأول والثاني الابتدائي (بنين)",
                        "الصف الثالث والرابع الابتدائي (بنين)",
                        "الصف الخامس والسادس الابتدائي (بنين)",
                        "الصف الأول والثاني والثالث الإعدادي (بنين)",
                        "بنات (جميع الأعمار)",
                    ],
                    index=0 if not st.session_state.get("reg_age") else
                          ["", "KG1 (بنين)", "KG2 (بنين)", "الصف الأول والثاني الابتدائي (بنين)",
            ...
            # حقل المجموعة - كل الخيارات موجودة للمستخدم
            group = st.selectbox(
                "المجموعة (مطلوب للصف الثالث/الرابع والخامس/السادس)",
                [
                    "لا توجد مجموعة",
                    "المجموعة أ (الإثنين والخميس 6:00 - 8:00 م) - للصف الثالث والرابع",
                    "المجموعة ب (السبت والثلاثاء 6:00 - 8:00 م) - للصف الثالث والرابع",
                    "المجموعة أ (الأحد والأربعاء 6:00 - 8:00 م) - للصف الخامس والسادس",
                    "المجموعة ب (السبت والثلاثاء 9:00 - 11:00 م) - للصف الخامس والسادس",
                ],
                index=0 if not st.session_state.get("reg_group") else
                      ["لا توجد مجموعة",
                       ...
                       "المجموعة ب (السبت والثلاثاء 6:00 - 8:00 م) - للصف الثالث والرابع",
                       "المجموعة أ (الأحد والأربعاء 6:00 - 8:00 م) - للصف الخامس والسادس",
                       "المجموعة ب (السبت والثلاثاء 9:00 - 11:00 م) - للصف الخامس والسادس"].index(st.session_state.get("reg_group", ""))
            )
            ...
            if submitted:
                ...
                if age_group == "الصف الثالث والرابع الابتدائي (بنين)":
                    if group not in [
                        ...
                        st.session_state.registration_error = "⚠️ الرجاء اختيار إحدى المجموعتين المخصصتين للصف الثالث والرابع الابتدائي"
                        st.rerun()
                elif age_group == "الصف الخامس والسادس الابتدائي (بنين)":
                    if group not in [
                        "المجموعة أ (الأحد والأربعاء 6:00 - 8:00 م) - للصف الخامس والسادس",
                        "المجموعة ب (السبت والثلاثاء 9:00 - 11:00 م) - للصف الخامس والسادس"
                    ]:
                        st.session_state.registration_error = "⚠️ الرجاء اختيار إحدى المجموعتين المخصصتين للصف الخامس والسادس الابتدائي"
                        st.rerun()
                else:
                    # الفئات الأخرى لا تحتاج مجموعة، نتركها فارغة
                    group = ""
