...
# إعدادات الحد الأقصى
# ====================================================================================================
MAX_PLAYERS = 0  # يمكن تغيير الرقم حسب الحاجة
...
# ====================================================================================================
# REGISTRATION PAGE - تجميع كل الخيارات في قائمة واحدة شاملة
# ====================================================================================================
    ...
    if current_count >= MAX_PLAYERS:
        ...
        with st.form("registration_form"):
            ...
            with col1:
                ...
                # قائمة واحدة تحتوي على جميع الفئات مع تفاصيل المواعيد
                age_group = st.selectbox(
                    "اختر الفئة العمرية والمواعيد *",
                    [
                        "",
                        "KG1 (الأحد والأربعاء - 8:00-9:00 م)",
                        "KG2 (السبت والثلاثاء - 8:00-9:00 م)",
                        "الصف الأول والثاني الابتدائي (الإثنين والخميس - 8:00-9:30 م)",
                        "الصف الثالث والرابع الابتدائي - مجموعة أ (الإثنين والخميس - 6:00-8:00 م)",
                        "الصف الثالث والرابع الابتدائي - مجموعة ب (السبت والثلاثاء - 6:00-8:00 م)",
                        "الصف الخامس والسادس الابتدائي - مجموعة أ (الأحد والأربعاء - 6:00-8:00 م)",
                        "الصف الخامس والسادس الابتدائي - مجموعة ب (السبت والثلاثاء - 9:00-11:00 م)",
                        "الصف الأول والثاني والثالث الإعدادي (الأحد والأربعاء - 9:00-11:00 م)",
                        "بنات (الإثنين والخميس - 9:30-11:00 م)",
                    ],
                    index=0 if not st.session_state.get("reg_age") else
                          ["", 
                           ...
                           "الصف الخامس والسادس الابتدائي - مجموعة ب (السبت والثلاثاء - 9:00-11:00 م)",
                           "الصف الأول والثاني والثالث الإعدادي (الأحد والأربعاء - 9:00-11:00 م)",
                           "بنات (الإثنين والخميس - 9:30-11:00 م)"].index(st.session_state.get("reg_age", ""))
                )
            with col2:
            ...
            if submitted:
                ...
                data_dict = {
                    ...
                    'age_group': age_group,          # النص الكامل من الاختيار
                    'group': '',                     # لم نعد نحتاج عمود المجموعة
                    'position': position,
